...
import static com.cxense.sdk.Cxense.pageViewEvent;
...
public class PageViewEventTest {
    ...
    public void testBasics() throws Exception {
        int responseCode = pageViewEvent("1234", "http://www.site.com/", "abcd")
                .send();
        assertEquals(responseCode, HttpStatus.OK_200);
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString, "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1");
    }
    ...
    public void testReferrer() throws Exception {
        ...
        int responseCode = pageViewEvent("1234", "http://www.site.com/", "abcd")
                ...
                .send();
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString, "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&ref=" + URLEncoder
                .encode(referrer, "UTF-8"));
    }
    ...
    public void testScreenSize() throws Exception {
        ...
        int responseCode = pageViewEvent("1234", "http://www.site.com/", "abcd")
                ...
                .send();
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString, "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&res=1024x768");
    }
    ...
    public void testWindowSize() throws Exception {
        ...
        int responseCode = pageViewEvent("1234", "http://www.site.com/", "abcd")
                ...
                .send();
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString, "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&wsz=927x349");
    }
    ...
    public void testDevicePixelRatio() throws Exception {
        ...
        int responseCode = pageViewEvent("1234", "http://www.site.com/", "abcd")
                ...
                .send();
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString, "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&dpr=1.4");
    }
    ...
    public void testGeoPosition() throws Exception {
        ...
        assertEquals(queryString,
                     "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&plat=7.6145&plon=110.7122");
    }
    ...
    public void testCustomParameter() throws Exception {
        int responseCode = pageViewEvent("1234", "http://www.site.com/", "abcd")
                ...
                .send();
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString, "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&cp_section=sports");
    }
    ...
    public void testCustomParameters() throws Exception {
        ...
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString,
                     "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&cp_a=1&cp_b=2&cp_c=3");
    }

    @Test
    public void testExternalId() throws Exception {
        int responseCode = pageViewEvent("1234", "http://www.site.com/", "abcd")
                .addExternalUserId("fb", "ABCD")
                .send();
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString, "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&eit0=fb&eid0=ABCD");
    }
    ...
    public void testExternalIds() throws Exception {
        ...
        int responseCode = pageViewEvent("1234", "http://www.site.com/", "abcd")
                ...
                .send();
        queryString = queryString.replaceAll("rnd=[0-9]+", "rnd=1");
        assertEquals(queryString, "typ=pgv&sid=1234&loc=http%3A%2F%2Fwww.site.com%2F&ckp=abcd&rnd=1&eit0=fbk&eid0=1");
    }
